...
var _STAR_ns_sym_STAR_3158 = cljs.core._STAR_ns_sym_STAR_;
try{cljs.core._STAR_ns_sym_STAR_ = cljs.core._STAR_ns_sym_STAR_;
return cljs.reader.read_string.call(null,text);
}finally {cljs.core._STAR_ns_sym_STAR_ = _STAR_ns_sym_STAR_3158;
}});
...
}catch (e3161){if(cljs.core.instance_QMARK_.call(null,Error,e3161))
{var e = e3161;
webrepl._STAR_e = e;
...
var _STAR_out_STAR_3169 = cljs.core._STAR_out_STAR_;
try{cljs.core._STAR_out_STAR_ = cljs.core._STAR_err_STAR_;
return cljs.core.print.call(null,"Compilation error:",err);
}finally {cljs.core._STAR_out_STAR_ = _STAR_out_STAR_3169;
}} else
{try{var _STAR_out_STAR_3174 = cljs.core._STAR_out_STAR_;
...
}finally {cljs.core._STAR_out_STAR_ = _STAR_out_STAR_3174;
}}catch (e3171){if(cljs.core.instance_QMARK_.call(null,Error,e3171))
{var e = e3171;
...
return true;
}catch (e3178){if(cljs.core.instance_QMARK_.call(null,Error,e3178))
{var e = e3178;
...
}),(function (p1__3176_SHARP_){
if(cljs.core.truth_(webrepl.complete_form_QMARK_.call(null,p1__3176_SHARP_)))
{return false;
} else
{return 0;
}
...
return jqconsole.Write(p1__3179_SHARP_);
});
cljs.core._STAR_rtn_STAR_ = (function (p1__3180_SHARP_){
return jqconsole.Write(p1__3180_SHARP_,"jqconsole-output");
});
cljs.core._STAR_err_STAR_ = (function (p1__3181_SHARP_){
return jqconsole.Write(p1__3181_SHARP_,"jqconsole-message-error");
});
